...
11. Install Windows Report Service (optional)
    1. Install the app and dependencies (only required if not using the Report Service AMI from AWS Marketplace)
       ...
       3. Download the [install-prereqs.ps1](/installation-scripts/install-prereqs.ps1) and [configure-startup.ps1](/static/installation-scripts/configure-startup.ps1) powershell scripts to the same temp folder.
