...
Occasionally you may experience an error when performing an action in Sage. When an error is received, it will like be shown in a red box in the upper right corner of your browser for a few seconds as shown here:
