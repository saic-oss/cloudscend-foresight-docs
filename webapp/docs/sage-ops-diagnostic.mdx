...
Occasionally you may experience an error when performing an action in Sage. When an error is received, it will likely be shown in a red box in the upper right corner of your browser for a few seconds as shown here:
...
**1. First, simply retry the activity a second time or in the case of a page not rendering, try refreshing the page. Occasionally you may have moments of communications failures with the database or other Sage containers.**
...
**1. Log on to Sage and perform the step that is failing.**
