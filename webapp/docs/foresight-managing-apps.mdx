...
| Trends                 | Health Factors, Code Size, Maintenance, CloudReady, Open Source across time. _Note, to see trends accurately, ensure source code uploads are done at least 24 hours apart._ |
...
**4. The filter options will now be shown. Of primary interest here, you can filter on technologies to narrow down your results to specific languages. If you filter on one or more languages, you dashboards will only show data for application that use that technology.**
...
:::note
In order to see trends you will need to have at least 24 hours between source code uploads. If multiple uploads are done in a day, the trends dashboard will use the data from the last scan of that day for its data point.
:::
...
**5. In order to see your trends over time, you will see there is a tab for New Code which will show you any newly added bugs, vulnerabilities, hotspots or debt that have been added with the most recent upload and scan of the code. This will allow you to see if newly changed code is causing your technical debt to rise.**
