...
| Does this system use shared filesystems/shared caching?                                                                    | Yes<br></br>No                                                                                                |
...
| Survey Question                                                                                    | Possible Answers                                                            |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| What is the number of major releases delivered over the last 12 months?                            | Less than 4<br></br>4 to 6<br></br>7 to 12<br></br>More than 12             |
...
Now that you have entered your information and taken the survey, it's time to upload your application source code. You will want to upload your source code to begin your migration estimate but you may upload your code at any other time as well. You will want to upload your source code throughout your refactoring process to keep track of your progress and keep on top of any new issues that have been created by your refactoring. While you can upload source code multiple times in a day, only the data from the last scan of the day will be used in any trend dashboards or continuous assessment views. To ensure you have data points for your trends, upload your source code on different calendar dates.
For detailed information regarding packaging your source code for uploading, refer to the [CloudScend Foresight Operations Guide](foresight-ops-standard-guidelines.mdx#system-tuning).
...
4. Software Resiliency index represents the presence of good or bad programming habits within your source code that make it more or less robust and secure. The higher the index the lower the likelihood of defects in production.
...
5. The Product Complexity value refers to specific areas of operations for your software that may affect the effort to migrate your application.
...
This shows you the calculated time in hours and calculated cost based on derived COCOMO parameters as well as the time and cost calculated by the ML model. If you would like to see what the COCOMO model would calculate with different parameters, you can use the Interactive Calculator to create a custom estimate.

**3. If you are interested in seeing an estimate based on custom values for your COCOMO model parameters, select the Interactive Calculator icon on the Migration Estimate screen.**
...
**5. If you would like the values and estimate you have just entered into the Interactive Calculator, then select the Save Estimate Button at the bottom of the screen.**
...
![Migration Actuals Reported](/img/SageResultsWithActuals.png)
...
| Trends                 | Health Factors, Code Size, Maintenance, CloudReady, Open Source across time. _Note, to see trends accurately, ensure source code uploads are done on different calendar dates._ |
...
**3. If you would like to seach for a specific application, you can use the search option at the top of the screen. Here you simply start entering the name that you entered during Onboarding and select it from the list.**

![Portfolio Search](/img/AppPortfolioSearch.png)

All of the information for the application you entered will now be shown to you in an overiew view with eight tabs of detailed information.

![Portfolio Search Results](/img/AppPortfolioSearchResults.png)
...
**2. If you would like to seach for a specific application, you can use the search option at the top of the SonarQube metrics. Here you simply start entering the name that you entered during Onboarding and select it from the list.**

![Search](/img/ContinuousAssessmentSearch.png)
...
**5. If you would like to see more details about any field from this view, simply click on the data value. In the instance shown below, we have clicked the '2d' vaue for Debt.**
...
| 5. Which applications have the highest number of critical vulnerabilities?                        | app_org.app_global_id<br></br>app_cast_highlight_tech_properties.app_cast_app_name<br></br>app_cast_highlight_tech_properties.app_cast_highlight_security_vulnerability_index_critical                                                                                                                                                                          |
